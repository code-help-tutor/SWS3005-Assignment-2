...
static void MyDrawFunc(void)
{
    ...
    //=======================================================================
    {
       ...
       // glm::mat4 modelMat0 = glm::mat4(1.0f);
        ...
        // Stick the skybox to the camera
        glm::mat4 modelMat0 = glm::translate(glm::mat4(1.0f), glm::vec3(camWorldPos.x, camWorldPos.y, camWorldPos.z));

        // Change the size of skybox 
        modelMat0 = glm::scale(modelMat0, glm::vec3(50.0f, 50.0f, 50.0f));

        // Rotate 0 degrees about x-axis.
        modelMat0 = glm::rotate(modelMat0, glm::radians(0.0f), glm::vec3(1.0f, 0.0f, 0.0f));
